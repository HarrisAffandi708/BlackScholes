...
The pnl values shows the pnl of the inputs given by the values above this section (without pnl image) combined with the call/put purchase price
<br>![Alt text](images/pnl.png)
